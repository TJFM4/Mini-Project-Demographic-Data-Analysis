...
def calculate_demographic_data(print_data=True):
    ...
    min_workers = round(df[df["hours-per-week"] == min_work_hours], 1)
    ...
    rich_pop_by_country = df[df["salary"] == ">50K"]["native-country"].value_counts()
    pop_by_country = df["native-country"].value_counts()
    percent_by_country = rich_pop_by_country / pop_by_country
    highest_earning_country_percentage = round(max(percent_by_country) * 100, 1)
